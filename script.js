    ...
    function showWeather(cityName) {
        ...
        $.ajax({
            ...
            .then(function (response) {
                ...
                $("#current-pic").attr("src", "https://cors-anywhere.herokuapp.com/openweathermap.org/img/wn/" + weatherPic + "@2x.png");
                ...
                $.ajax({
                    ...
                    .then(function (answer) {
                        ...
                        for (i = 0; i < 5; i++) {
                            ...
                            $('.pic').each(function (i) {
                                $(this).attr("src", "https://cors-anywhere.herokuapp.com/openweathermap.org/img/wn/" + answer.daily[i + 1].weather[0].icon + "@2x.png");
                            });
                            $('.pic').each(function (i) {
